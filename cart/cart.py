...
from furnitures.models import FurnituresModel
...
class Cart(object):
    ...
    def add(self, product, quantity, update_quantity=False):
        """Добавляем товар в корзину пользователя, или обновление количество товаров"""
    ...
    def __iter__(self):
        ...
        products = FurnituresModel.objects.filter(id__in=product_ids)
